...
cat ./testdata/sexpr.rd | ./target/roonda --dry-run > ./actual/sexpr.sh || RESULT=1
...
cat ./testdata/from-json.js | ./target/roonda --from-json --dry-run > ./actual/from-json.sh || RESULT=1
...
cat ./testdata/sh-env.rd | ./target/roonda --dry-run > ./actual/sh-env.sh || RESULT=1
...
cat ./testdata/sh-pipe.rd | ./target/roonda --dry-run > ./actual/sh-pipe.sh || RESULT=1
...
cat ./testdata/sh-embed-script.rd | ./target/roonda --dry-run > ./actual/sh-embed-script.sh || RESULT=1
...
cat ./testdata/sh-backticks.rd | ./target/roonda --dry-run > ./actual/sh-backticks.sh || RESULT=1
diff -u expected/sh-backticks.sh actual/sh-backticks.sh

echo ./testdata/sh-strcat.rd
cat ./testdata/sh-strcat.rd | ./target/roonda --dry-run > ./actual/sh-strcat.sh || RESULT=1
...
cat ./testdata/sh-exec.rd | ./target/roonda --dry-run > ./actual/sh-exec.sh || RESULT=1
diff -u expected/sh-exec.sh actual/sh-exec.sh

echo ./testdata/sh-call-roonda.rd
cat ./testdata/sh-call-roonda.rd | ./target/roonda --dry-run > ./actual/sh-call-roonda.sh || RESULT=1
...
cat ./testdata/sh-call-langs.rd | ./target/roonda --dry-run > ./actual/sh-call-langs.sh || RESULT=1
...
cat ./testdata/basic.rd | ./target/roonda --dry-run > ./actual/basic.sh || RESULT=1
...
cat ./testdata/operators.rd | ./target/roonda --dry-run > ./actual/operators.sh || RESULT=1
...
cat ./testdata/statements.rd | ./target/roonda --dry-run > ./actual/statements.sh || RESULT=1
